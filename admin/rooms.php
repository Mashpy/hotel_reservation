							...
							while($row = mysql_fetch_array($result))
								{
									...
									echo '<td style="border-left: 1px solid #C1DAD7;">'.$id.'-'.$type.'</td>';
									echo '<td><div align="right">'.$row['unit_price'].'</div></td>';
									echo '<td><div align="right">'.$row['auto-id'].'</div></td>';
									echo '<td><div align="right">'.$row['description'].'</div></td>';
									echo '<td><img src="../reservation/'.$row['image'].'" width="80" height="50"></a></td>';
									echo '<td><div align="center"><a rel="facebox" href="editroomdetails.php?">edit</a> | <a href="#"  class="delbutton" title="Click To Delete">delete</a></div></td>';
									echo '</tr>';
								}
							?> 
						</tbody>
