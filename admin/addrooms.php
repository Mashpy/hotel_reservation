...
{
var f=a=document.forms["addroom"]["id"].value;
if (f==null || f=="")
  {
...
Reserv_id<br />
    <input name="id" type="numeric" id="rate" class="ed" onkeypress="return isNumberKey(event)" /><br />
 RoomType<br />
  <input name="type" type="text" class="ed" /><br />
 Rate<br />
    <input name="rate" type="int" id="rate" class="ed" onkeypress="return isNumberKey(event)" /><br />
 Room Number<br />
