...
<div id="wrapper">
    	...
    	<div id="rotator">
			  ...
			  <div id="logo" style="left: 600px; height: auto; top: 23px; width: 260px; position: absolute; z-index:4;">
					...
					<div class="accordion-content" style="margin-bottom: 15px;">
						<form action="reservation/demonew.php" method="post" style="padding-top: 4px;">
    ...
    <div id="featured">
        <div id="items">
            ...
            <p><a href="#"><strong>New Signature Dishes</strong><br />
            ...
            <h3><a href="#">Lodging Available</a></h3>
            <p><a href="#"><strong>The Innovation Hotel</strong><br />
			Spend a relaxing evening in our hotel, steeped in history. </a></p>  
			</div>
        </div>
        <div id="wedding"> <a href="#"><img src="xres/images/wedding_btn.jpg" alt="For Special Offers and Discounts" /></a>
        </div>
    </div>

	<div id="footer">
		<h4> &bull; <a href="contact-us.php">Maijdee Avenue, Noakhali District, Bangladesh  </a></h4>
